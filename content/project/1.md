...
Next, you will move your work into code. You’ll take the text content from your sketches and layer it into [HTML structures](../topic/html/index.md)—focusing on appropriate, semantic elements that reflect the usage in your selection. This won’t yet be a styling exercise; instead we will think about grouping and nesting the content. You should use a range of [HTML elements](https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements) to achieve this.
